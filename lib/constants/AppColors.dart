...
class AppColors {
  ...
  static Color black = HexColor("#262626");
  static Color primaryColor = HexColor("#3498DB");
  static Color secondaryColor = HexColor("#2CC189");
  static Color lightgrey = HexColor("#F2F2F2");
  static Color grey = HexColor("#c2c2c2");
  static Color red = HexColor("#e74c3c");
  static Color green = HexColor("#2ecc71");
  static Color blueishWhite = HexColor("#F0F5FC");
  static Color lightBlack = HexColor("#34495e");
  static Color deepKoamaru = HexColor("#30336b");
