...
UnsyncedResponse unsyncedResponseFromJson(String str) =>
    UnsyncedResponse.fromJson(json.decode(str));

String unsyncedResponseToJson(UnsyncedResponse data) =>
...
class UnsyncedResponse {
  ...
  factory UnsyncedResponse.fromJson(Map<String, dynamic> json) =>
      UnsyncedResponse(
        ...
        funds: json["funds"] == null
            ? []
            : List<FundModel>.from(
                json["funds"]!.map((x) => FundModel.fromJson(x))),
        admins: json["admins"] == null
            ? []
            : List<AdminModel>.from(
                json["admins"]!.map((x) => AdminModel.fromJson(x))),
      );
