...
enum RtmpConnectionCode {
  ...
  connectNetworkChange("NetConnection.Connect.NetworkChange", EventLevel.status),
...
enum RtmpStreamCode {
  ...
  playFileStructureInvalid("NetStream.Play.FileStructureInvalid", EventLevel.error),
  playInsufficientBW("NetStream.Play.InsufficientBW", EventLevel.error),
  playNoSupportedTrackFound("NetStream.Play.NoSupportedTrackFound", EventLevel.error),
  ...
  recordDiskQuotaExceeded("NetStream.Record.DiskQuotaExceeded", EventLevel.error),
