...
class GroupMediaWidget extends StatelessWidget {
  ...
  const GroupMediaWidget({super.key, required this.postIndex, required this.mediaIndex});
  ...
  Widget build(BuildContext context) {
    ...
    return PageView.builder(
      ...
      itemCount: videoController.postsForYouData[postIndex].media.length,
...
class _MediaWidgetState extends State<MediaWidget> {
  ...
  void initState() {
    ...
    super.initState();
    postMediaUrl = videoController.postsForYouData[widget.postIndex].media[widget.mediaIndex].url.toString();
    mediaType = videoController.postsForYouData[widget.postIndex].media[widget.mediaIndex].type.toString();
  ...
  Widget build(BuildContext context) {
    ...
    var mediaType = videoController.postsForYouData[widget.postIndex].media[widget.mediaIndex].type;
    if (mediaType!.contains("video/quicktime")) {
      return Obx(
        () => VisibilityDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image:
                          NetworkImage("https://${videoController.postsForYouData[widget.postIndex].media[widget.mediaIndex].thumbnail.toString()}"),
      ...
      return Container(
          ...
          child: Image.network("https://${videoController.postsForYouData[widget.postIndex].media[widget.mediaIndex].url.toString()}",
