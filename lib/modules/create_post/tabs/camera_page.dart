...
class _CameraPageState extends State<CameraPage> with WidgetsBindingObserver, TickerProviderStateMixin {
  ...
  Widget _thumbnailWidget() {
    final CachedVideoPlayerPlusController? localVideoController = cachedVideoPlayerPlusController;
              ...
              SizedBox(
                ...
                child: (localVideoController == null)
                    ...
                    : Container(
                        ...
                        child: Center(
                          child: AspectRatio(aspectRatio: localVideoController.value.aspectRatio, child: CachedVideoPlayerPlus(localVideoController)),
                        ),
                      ),
              ),
          ],
  ...
  Future<void> _startVideoPlayer() async {
    ...
    final CachedVideoPlayerPlusController vController =
        kIsWeb ? CachedVideoPlayerPlusController.networkUrl(Uri.parse(videoFile!.path)) : CachedVideoPlayerPlusController.file(File(videoFile!.path));
